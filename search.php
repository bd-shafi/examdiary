...
<head>
    ...
    <title>Search | Exam Calendar</title>
    <meta charset="utf-8">
	...
	if($_GET['submit'] != NULL){ 
	  ...
	  ?>
	  	...
	  	echo $title; ?>
                ...
                <?php
	if($query != 'my_notess'){
	         $sql = "SELECT *  FROM examdata where 1=1 and status='1' $queserysql order by time desc limit 100";
	  }else{
...
where 1=1  and examdata.status='1' and notes.userid='$userid' order by examdata.time desc limit 100
  ";
	  }
