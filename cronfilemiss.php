...
$today = date("Y-m-d H:i:s");
 $sql = "SELECT id, oldjobid,shortcode, applystart FROM examdata where file='0' and filecron='1' and oldjobid!='0' limit 1 ";
    ...
    if (mysqli_num_rows($result) > 0) {
     $i=0;
        ...
        while($row = mysqli_fetch_assoc($result)) {
			 ...
			 $sqlf = "update examdata set filecron='2' where id = '$row[id]' limit 1 ";
