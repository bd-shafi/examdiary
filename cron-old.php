...
$sqlrow = "SELECT * FROM startend where id='1' ";
...
for($k=$ended+1; $k<=$ended+1; $k++){

$links = 'https://alljobs.teletalk.com.bd/bn/jobs/govt/expiry/job/?page=1';
...
$xelems = $xcompany->query('//div[contains(@class,"col-lg-8 col-md-9 col-12 mb-9 pr-0")]');
...
foreach($arrayjoblis as $index=>$data){
	...
	$alldesignation .=$data['h5'].'#';
	 ...
	 $sql2=" insert examdatapreold2 set 
            jobid =  '$data[link]',
            designation='$data[h5]'
            ";
